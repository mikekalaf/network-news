...
- (void)testUnfolding {
    ...
    XCTAssert([entry.value isEqualToString:@"First Line Second Line Third Line"], "Unexpected header 1 value");

    entry = parser.entries[1];
    XCTAssert([entry.name isEqualToString:@"Heading-2"], "Unexpected header 2 name");
    XCTAssert([entry.value isEqualToString:@"One Line"], "Unexpected header 2 value");
}

- (void)testHeaderParsing {

    NSString *article = @"220 status line (should this be here?)\r\n"
    @"X-Received: by 10.55.39.202 with SMTP id n193mr7407498qkn.14.1522724473069;\r\n"
    @" Mon, 02 Apr 2018 20:01:13 -0700 (PDT)\r\n"
    @"X-Received: by 10.31.69.207 with SMTP id s198mr1469776vka.0.1522724472888;\r\n"
    @" Mon, 02 Apr 2018 20:01:12 -0700 (PDT)\r\n"
    @"Path: eternal-september.org!reader02.eternal-september.org!feeder.eternal-september.org!paganini.bofh.team!weretis.net!feeder6.news.weretis.net!feeder.usenetexpress.com!feeder-in1.iad1.usenetexpress.com!border1.nntp.dca1.giganews.com!nntp.giganews.com!k3no133715qtm.1!news-out.google.com!c39ni1306qta.0!nntp.google.com!d11no139430qth.0!postnews.google.com!glegroupsg2000goo.googlegroups.com!not-for-mail\r\n"
    ...
    @"References: <5325545a-9fe8-4ffd-ab84-0e3468ff7bb9@googlegroups.com> <CALwzid=CeE7RkW01oyJT8mVbTQC_eKJjgmSQXTiyC2ocsj87qA@mail.gmail.com> <mailman.105.1522676213.3863.python-list@python.org>\r\n"
    @"User-Agent: G2/1.0\r\n"
    @"MIME-Version: 1.0\r\n"
    @"Message-ID: <1c54182f-05f4-4e73-b39d-dd03a05e4bfe@googlegroups.com>\r\n"
    @"Subject: Re: In asyncio, does the event_loop still running after run_until_complete returned?\r\n"
    ...
    XCTAssert([entry.value isEqualToString:@"reader02.eternal-september.org comp.lang.python:221442"],
