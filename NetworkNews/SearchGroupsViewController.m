...
- (void)viewWillDisappear:(BOOL)animated {
  ...
  //        sharedApplication] delegate]; NSString *path = [[appDelegate
  //        cacheRootDir] stringByAppendingPathComponent:@"groups.plist"];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)aSearchBar {
  ...
  GroupListSearchOperation *operation =
      [[GroupListSearchOperation alloc] initWithConnectionPool:_connectionPool
                                                       wildmat:wildmat];
  operation.completionBlock = ^{
    NSSortDescriptor *sortDescriptor =
        [[NSSortDescriptor alloc] initWithKey:@"count" ascending:NO];
    self->_foundGroupList =
        [operation.groups sortedArrayUsingDescriptors:@[ sortDescriptor ]];
