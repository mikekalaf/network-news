                         ...
                         subject:(NSString *)subject
{
    ...
    [headers addObject:[[NNHeaderEntry alloc] initWithName:@"From"
                                                     value:from]];
                      ...
                      formatFlowed:(BOOL)formatFlowed
{
    ...
    [mimeHeaders addObject:[[NNHeaderEntry alloc] initWithName:@"Content-Type"
                                                         value:contentType]];
    [mimeHeaders addObject:[[NNHeaderEntry alloc] initWithName:@"Content-Transfer-Encoding"
                                                         value:contentTransferEncoding]];
    NSArray *completeHeaders = [headers arrayByAddingObjectsFromArray:mimeHeaders];
