...
//        }
//
//        NSInteger day = [dateString substringWithRange:[match rangeAtIndex:2]].integerValue;
//        NSInteger month = [dateString substringWithRange:[match rangeAtIndex:3]].integerValue;
//        NSInteger year = [dateString substringWithRange:[match rangeAtIndex:4]].integerValue;
//        if (year < 100)
//            year += 2000;
//        NSInteger hour = [dateString substringWithRange:[match rangeAtIndex:5]].integerValue;
//        NSInteger minute = [dateString substringWithRange:[match rangeAtIndex:6]].integerValue;
//        NSInteger second = [dateString substringWithRange:[match rangeAtIndex:7]].integerValue;
//        NSString *tz = [dateString substringWithRange:[match rangeAtIndex:8]];
//        unichar tzPrefix = [tz characterAtIndex:0];
//        if (tzPrefix == '+' || tzPrefix == '-')
//    }
//    else
//    {
...
//    }
    ...
    if (date == nil)
    {
        ...
        str = [str stringByTrimmingCharactersInSet:[NSCharacterSet letterCharacterSet]];
