...
- (void)viewDidLoad {
  ...
  self.title = [NSString
      stringWithFormat:@"%lu Articles", (unsigned long)_articles.count];

  // We need to do this just to have the back button show "Thread" rather than
  // the title
  UIBarButtonItem *backButtonItem =
      [[UIBarButtonItem alloc] initWithTitle:@"Thread"
  ...
  //    imageNamed:@"icon-toolbar-info.png"]
  //                                     style:UIBarButtonItemStylePlain
  //                                    target:self
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  cell.textLabel.text =
      [emailAddressFormatter stringForObjectValue:article.from];
  ...
  long long articleNumber =
      [[article.parts anyObject] articleNumber].longLongValue;

  if (article.hasAllParts == NO)
    cell.imageView.image = incompleteIconImage;
  else if ([newsrc isReadForGroupName:_groupName
                        articleNumber:articleNumber] == NO)
...
//    {
//        ArticleViewController *viewController = [[ArticleViewController alloc]
//        initWithNibName:@"ArticleView"
//                                                                                        bundle:nil];
...
//        sharedApplication] delegate]; ArticleViewController *viewController =
//        [appDelegate articleViewController];
//
//        [viewController setConnectionPool:_connectionPool];
//        viewController.articleSource = self;
//        viewController.articleIndex = indexPath.row;
...
- (UIView *)tableView:(UITableView *)tableView
  ...
  ThreadSectionHeaderView *view =
      [[ThreadSectionHeaderView alloc] initWithFrame:CGRectZero];
