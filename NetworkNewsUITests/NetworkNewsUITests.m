...
- (void)testTest {
  ...
  //    [app.tables/*@START_MENU_TOKEN@*/.staticTexts[@"misc.test"]/*[[".cells.staticTexts[@\"misc.test\"]",".staticTexts[@\"misc.test\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
  //    tap]; [app.activityIndicators[@"In progress"] tap];
}
...
- (void)testPostArticle {
  ...
  //    XCUIElement *textView = [app.textViews
  //    containingType:XCUIElementTypeTextView identifier:@"To:"].element;
  XCUIElement *textView = app.textViews.element;
  [textView tap];

  NSString *text = [NSString
      stringWithFormat:@"Testing at %@\n\n", [[NSDate date] description]];
  ...
  //    XCUIElement *moreKey =
  //    app/*@START_MENU_TOKEN@*/.keys[@"more"]/*[[".keyboards",".keys[@\"more,
  //    numbers\"]",".keys[@\"more\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/;
  //    [moreKey tap];
  //    [moreKey tap];
  //    [app/*@START_MENU_TOKEN@*/.keys[@"1"]/*[[".keyboards.keys[@\"1\"]",".keys[@\"1\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
  //    tap];
  //    [app/*@START_MENU_TOKEN@*/.keys[@"2"]/*[[".keyboards.keys[@\"2\"]",".keys[@\"2\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
  //    tap];
  //
  //    XCUIElement *key =
  //    app/*@START_MENU_TOKEN@*/.keys[@"3"]/*[[".keyboards.keys[@\"3\"]",".keys[@\"3\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/;
  //    [key tap];
  //    [key tap];
